      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-6 flex max-w-4xl flex-wrap items-center justify-around sm:w-full">
          ...
          >
            ...
            <p className="mt-4 text-xl">Log into an account</p>
          </Link>
          ...
          >
            ...
            <p className="mt-4 text-xl">Create a new account</p>
          </Link>
          ...
          >
            ...
            <p className="mt-4 text-xl">Check the current session</p>
          </Link>
          ...
          >
            ...
            <p className="mt-4 text-xl">Check if you&apos;re an admin</p>
          </Link>
          ...
          >
            ...
            <p className="mt-4 text-xl">Check if you&apos;re a moderator</p>
          </Link>
        </div>
      </main>
